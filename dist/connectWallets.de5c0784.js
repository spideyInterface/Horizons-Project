...
const trendingSlider1 = new Trending("LIBERATED PUNKS", "In a world of oppression and violation by the rich and powerful, a group of misfits strive to rebel against those that bring them down.", "FLOOR PRICE: 3.5ETH", "CREATED BY: JINX EKKO", "https://i.pinimg.com/originals/45/df/82/45df82b13b747404087c04a64240893c.jpg");
const trendingSlider2 = new Trending("TOXIC UNDERKEEP", "Every city needds their golden girl, and here she is.", "FLOOR PRICE: 2.8ETH", "CREATED BY: VIOLET KIRAMANN", "https://wallpapers.com/images/hd/arcane-vi-from-prison-w3y59q9vwijsuz4o.jpg");
const trendingSlider3 = new Trending("ROYAL CORRUPTION", "Now matter how posh, rich, or clean someone or something is, there lies a dirty, broken, or treachorous face that wears a mask to cover it all up.", "FLOOR PRICE: 1.5ETH", "CREATED BY: VANDETTA KYLE", "https://i.pinimg.com/736x/d6/60/3c/d6603cbc84a86ee2d078e05b38ed0c9d.jpg");
const trendingSlider4 = new Trending("GOLDEN", "Riches, riches and more riches. Aspiration does not discriminate.", "FLOOR PRICE: 7ETH", "CREATED BY: JEMIAH DAVIS", "https://www.popsugar.com.au/wp-content/uploads/sites/2/2021/11/arcane-netflix-2000x1000-1.jpg");
const trendingSlider5 = new Trending("BEACONS", "Despite the grime and blood stained streets, hope and aspiration prevail as every home needs a beacon of hope.", "FLOOR PRICE: 4ETH", "CREATED BY: JULIAN MDAMA", "https://wallpapers.com/images/hd/arcane-fearless-vander-ma54uf5juwycucuh.jpg");
